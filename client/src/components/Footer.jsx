      ...
      >
        <div>
          ...
          <p className="max-w-[410px] mt-6">
            ...
            Reprehenderit, repellendus. Nesciunt possimus amet nostrum est quae,
            pariatur illum maxime quod distinctio id nobis aspernatur nemo
            accusamus, voluptate molestiae itaque minima.
          </p>
        </div>
